# Taken from here:
# https://github.com/pycountry/pycountry/blob/main/src/pycountry/databases/iso3166-1.json
codes = [
    {
        'alpha_2': 'AW',
        'alpha_3': 'ABW',
...
lookup = {
    country['alpha_3']: int(country['numeric'])
    for country in codes
}


# import json
# from converter.iso31661 import codes
# lookup = {
#     int(country['numeric']): country
#     for country in codes
# }
# gj = json.load(open('frontend/public/world-110m.json'))
# for o in gj['objects']['countries']['geometries']:
#     o['properties'] = lookup.get(o['id'])
# json.dump(gj, open('frontend/public/world-110m-named.json', 'w'))
