...
import { onMounted, Ref, ref, triggerRef, watch } from "vue";
...
import type { View1D, View0DState, View1DState } from "falcon-vis";
...
const countState: Ref<View0DState> = ref({
  total: null,
  filter: null,
});
let pyView: View1D;
  ...
  <div class="d-flex flex-row">
    <div id="topbar" tabindex="0" class="col-2">
      <div id="title-wrapper" class="flex flex-jc-sb">
        ...
        <div v-if="countState">
          {{ Number(countState.filter).toLocaleString() }} /
